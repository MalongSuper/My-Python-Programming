...
def connect_four(connectfour_frame, back_to_control_panel):  # Create a game with CPU
    ...
    back_icon = load_resized_icon('home_button.png', (30, 30))  # Path to back icon
...
if __name__ == "__main__":
    ...
    icon_image = Image.open("connect_four_icon.png")
    ...
    connect_img = Image.open("connect_four_icon.png")
